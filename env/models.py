...
class ShiftResult(BaseModel):
    ...
    labor_costs: float = Field(ge=0, default=0)
    food_costs: float = Field(ge=0, default=0)
    reorder_costs: float = Field(ge=0, default=0)
    stockout_failures: int = Field(ge=0, default=0)
    capacity_failures: int = Field(ge=0, default=0)
    service_rate: float = Field(ge=0, le=1, default=0)
